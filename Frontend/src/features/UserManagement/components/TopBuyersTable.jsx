...
const TopBuyersTable = ({ buyers }) => {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden 
      ...
      {/* Header */}
      <div className="px-6 py-5 bg-gradient-to-r from-amber-500 to-yellow-600">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-white text-lg">Top Buyers</h3>
              <p className="text-yellow-100 text-sm">By Total Spend</p>
            </div>
          </div>
            ...
            {buyers.map((buyer, index) => (
              <tr key={index} 
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center 
                                  text-white font-bold shadow-lg group-hover:scale-110 transition-transform
                ...
                <td className="px-6 py-4 whitespace-nowrap text-center">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-blue-100 to-indigo-100 
                                rounded-full">
                    <ShoppingBag className="w-4 h-4 text-blue-600" />
                    <span className="font-semibold text-blue-700">{buyer.orders}</span>
                  </div>
                </td>
              </tr>
            ))}

  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 animate-in fade-in duration-500">
      <button
        ...
        className={`bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-xl border-2 transition-all duration-300 hover:shadow-2xl transform hover:scale-105 ${
      ...
      >
        <div className="flex items-center justify-between">
          <div className="text-left">
            ...
            <p className="text-4xl font-bold text-blue-600">{stats.totalRequests}</p>
          </div>
      ...
      >
        <div className="flex items-center justify-between">
          <div className="text-left">
            ...
            <p className="text-4xl font-bold text-red-600">{stats.banned}</p>
          </div>

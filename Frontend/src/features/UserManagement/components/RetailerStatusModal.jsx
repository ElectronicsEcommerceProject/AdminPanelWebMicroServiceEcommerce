  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-2 md:p-4 animate-in fade-in duration-300">
      <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[95vh] flex flex-col shadow-2xl animate-in zoom-in-95 slide-in-from-bottom-4 duration-300">
        ...
        {/* Header */}
        <div className="px-4 md:px-8 py-4 md:py-6 bg-gradient-to-r from-orange-500 to-red-500 rounded-t-2xl flex-shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg md:text-2xl font-bold text-white">{selectedRetailer.name}</h2>
                <p className="text-orange-100 text-xs md:text-sm mt-1">{selectedRetailer.businessName}</p>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="p-4 md:p-8 space-y-6 md:space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-gray-800 flex items-center gap-2 text-base md:text-lg">
                <User className="w-5 md:w-6 h-5 md:h-6 text-orange-500" />
                Retailer Information
              </h3>
            ...
            <div className="space-y-6">
              <h3 className="font-bold text-gray-800 flex items-center gap-2 text-base md:text-lg">
                <AlertCircle className="w-5 md:w-6 h-5 md:h-6 text-orange-500" />
                Change Status
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 md:px-6 py-3 md:py-4 text-sm md:text-base bg-gradient-to-r from-yellow-500 to-orange-600 
        ...
        {/* Footer */}
        <div className="px-4 md:px-8 py-4 md:py-6 bg-gray-50 rounded-b-2xl flex flex-col sm:flex-row justify-between items-center gap-3 flex-shrink-0 border-t border-gray-200">
